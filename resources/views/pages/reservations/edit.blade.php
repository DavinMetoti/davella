...
<div class="flex justify-between items-center mb-6">
    ...
    <div class="flex space-x-3">
        <a href="{{ route('reservations.show', $reservation) }}" class="btn-secondary hover:bg-opacity-90 px-4 py-2 rounded-lg transition duration-200">
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
    <form method="POST" action="{{ route('reservations.update', $reservation) }}" class="space-y-6">
            ...
            <div>
                ...
                <select name="sales_id" id="sales_id" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2FA769] focus:border-[#2FA769] transition duration-200 bg-gray-50 focus:bg-white" required>
                    ...
                    @foreach($salesUsers as $sales)
                        <option value="{{ $sales->id }}" {{ old('sales_id', $reservation->sales_id) == $sales->id ? 'selected' : '' }}>
                            {{ $sales->name }}
                        </option>
                    @endforeach
                </select>
        ...
        <div>
            ...
            <select name="status" id="status" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2FA769] focus:border-[#2FA769] transition duration-200 bg-gray-50 focus:bg-white" required>
        ...
        <div class="border-t pt-6">
            ...
            <div class="mt-6">
                ...
                <input type="text" name="ktp_number" id="ktp_number" value="{{ old('ktp_number', $reservation->ktp_number) }}"
                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2FA769] focus:border-[#2FA769] transition duration-200 bg-gray-50 focus:bg-white"
        ...
        <div class="border-t pt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="datetime-local" name="reservation_date" id="reservation_date" value="{{ old('reservation_date', $reservation->reservation_date->format('Y-m-d\TH:i')) }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2FA769] focus:border-[#2FA769] transition duration-200 bg-gray-50 focus:bg-white"
                           required>
                ...
                <div>
                    ...
                    <input type="datetime-local" name="expired_at" id="expired_at" value="{{ old('expired_at', $reservation->expired_at->format('Y-m-d\TH:i')) }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2FA769] focus:border-[#2FA769] transition duration-200 bg-gray-50 focus:bg-white"
                           required>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <select name="payment_method" id="payment_method" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2FA769] focus:border-[#2FA769] transition duration-200 bg-gray-50 focus:bg-white">
                        ...
                        <option value="transfer" {{ old('payment_method', $reservation->payment_method) == 'transfer' ? 'selected' : '' }}>Bank Transfer</option>
                        <option value="credit_card" {{ old('payment_method', $reservation->payment_method) == 'credit_card' ? 'selected' : '' }}>Credit Card</option>
                    </select>
