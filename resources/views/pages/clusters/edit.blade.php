    ...
    <form method="POST" action="{{ route('clusters.update', $cluster) }}" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="price_range_min" id="price_range_min" value="{{ old('price_range_min', $cluster->price_range_min) }}"
            ...
            <div>
                ...
                <input type="text" name="price_range_max" id="price_range_max" value="{{ old('price_range_max', $cluster->price_range_max) }}"
                       class="currency-input w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2FA769] focus:border-[#2FA769] transition duration-200 bg-gray-50 focus:bg-white"
                       placeholder="0">
